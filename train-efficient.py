...
from utils import efficient_b4_conf as config
from utils.augmentation_utils import train_transform, val_transform
...
def main():
    ...
    model_fc = nn.Linear(in_features=model._fc.in_features, out_features=2)
        ...
        with torch.no_grad():
            ...
            if epoch_acc > best_acc:
                ...
                shutil.copy(ckpt_path,
                            os.path.join(config.save_dir, "best_efficient_b4.pth"))
                best_acc = epoch_acc
